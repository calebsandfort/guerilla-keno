...
export const entityQueryCtor = ({ isAndQuery = true, enablePaging = false, startRowIndex = 0, maximumRows = 0, sortExpression = "", searchFilters = [] }) => {
  return {
    isAndQuery,
    enablePaging,
    startRowIndex,
...
export const searchFilterConditionToSequelizeOperator = searchFilterCondition => {
  ...
  switch (searchFilterCondition) {
    ...
    case SearchFilterCondition.IsNot:
      ...
      break;
    case SearchFilterCondition.IsLessThan:
      sequalizeOp = Sequelize.Op.lt;
      break;
    case SearchFilterCondition.IsLessThanOrEqual:
      sequalizeOp = Sequelize.Op.lte;
      break;
    case SearchFilterCondition.IsGreaterThan:
      sequalizeOp = Sequelize.Op.gt;
      break;
    case SearchFilterCondition.IsGreaterThanOrEqual:
      sequalizeOp = Sequelize.Op.gte;
      break;
  }
